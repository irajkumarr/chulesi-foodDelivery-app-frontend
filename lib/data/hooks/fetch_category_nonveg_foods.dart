...
FetchFood useFetchCategoryNonvegFoods(String categoryId) {
  // final categoryProvide = Provider.of<CategoryProvider>(context);
   ...
   if (!context.mounted) return;
    ...
    try {
      final response = await http.get(
          Uri.parse("$kAppBaseUrl/api/foods/category/$categoryId/non-veg"));
