...
FetchFood useFetchAllCategoryFoods(String categoryId) {
  ...
  Future<void> fetchData() async {
    ...
    try {
      final response = await http
          .get(Uri.parse("$kAppBaseUrl/api/foods/category/$categoryId/all"));
      ...
      if (response.statusCode == 200) {
        ...
        error.value = ApiError(
            status: false, message: "No items found for the selected category");
      } else {
        throw ApiError(
            status: false,
